...
class router extends CustomRouter{
    init() {
        ...
        this.post('/AddProduct', ['USER','ADMIN'], cartController.AddProductCart) 
        ...
        this.get('/', ['USER','ADMIN'], cartController.getAllProducts)

        // ruta para listar todos los carritos
        this.get('/', ['ADMIN'], cartController.listAllCarts)

        //PUT api/carts/:cid/products/:pid deberá poder actualizar SÓLO la cantidad de ejemplares del producto por cualquier cantidad pasada desde req.body
        this.put('/', ['USER','ADMIN'], cartController.UpdateQuantityCart)

        // DELETE api/carts deberá eliminar todos los productos del carrito 
        this.delete('/', ['USER','ADMIN'], cartController.RemoveAllProductsCart)

        // DELETE api/carts/products/:pid deberá eliminar del carrito el producto seleccionado.
        this.delete('/products/:pid', ['USER','ADMIN'], cartController.RemoveProductCart)

        this.post('/purchase', ['USER','ADMIN'], cartController.completePurchase)
    }
}
